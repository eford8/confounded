...
Because of the sensitive nature of this data (i.e. gene product levels in organisms may respond drastically to small environmental changes) and of the equipment used to quantify expression levels, expression data often contains unwanted confounding effects that can skew analysis.
...
Since both of these methods use linear methods to model batch effects, they are not designed to account for nonlinear effects, such as complex interactions in gene pathways in response to environmental changes.
