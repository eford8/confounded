...
The discriminator subnetwork consists of an input layer; four fully connected hidden layers of sizes 1024, 512, 512, and 128, respectively; and an output layer sized based on the number of batches[@Please provide a little more detail about how the output layer size is calculated@].
...
Unfortunately, most of these methods lack a common interface and common assumptions that input datasets must meet.[@This won't be convincing enough to the reviewers. Be more explicit about why we couldn't use these other methods.@]
...
[@Say something about what hyperparameters we used. Defaults?@]
