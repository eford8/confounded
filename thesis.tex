...
% \usepackage{natbib}
\usepackage[nomarkers,nolists,tabhead,fighead]{endfloat}
...
\begin{figure}
	...
	\caption[Batch adjustment steps]{\textbf{Batch adjustment justification and steps}
	\begin{enumerate*}[(a)]
...
\begin{figure}
	...
	\caption[Autoencoder and discriminator loss]{\textbf{Autoencoder and discriminator loss} over time for one run of Confounded.
...
\begin{table}
	...
	\caption[Dataset information]{\textbf{Dataset information} for each dataset used.}
	\label{tab:datasets}
\end{table}
...
\begin{figure}
	...
	\caption[Mean squared error]{\textbf{Mean squared error} (MSE) between the data prior to and after adjustment with various algorithms.
...
\begin{figure}
	...
	\caption[Maximum mean discrepancy]{\textbf{Maximum mean discrepancy} (MMD) between different batches. Lower MMD indicates that the distributions of the different batches are more similar.
...
\begin{table}
	...
	\caption[Batch classification accuracy]{\textbf{Batch classification accuracy} for several datasets and adjusters.
...
\begin{figure}
	...
	\caption[True class classification accuracy]{\textbf{True class classification accuracy} for several datasets and adjusters with 4-fold cross-validation repeated 3 times.
...
\begin{table}
	...
	\caption[True class classification accuracy]{\textbf{True class classification accuracy} for several datasets and adjusters.
...
\begin{enumerate*}[(a)]
	...
	In cases where ComBat is unable to completely remove batch effects in a small dataset, Confounded may be a viable replacement method.
\end{enumerate*}
