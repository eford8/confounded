...
\begin{abstract}
	...
	Covariates that are not of interest to the study may have strong effects on gene expression,
	and there may be systemic platform effects when integrating multiple datasets.
